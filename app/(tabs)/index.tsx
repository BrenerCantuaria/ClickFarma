...
export default function TelaPrincipal() {
  ...
  const produtosFarmacia = [
    ...
    },
    {
      ...
      imagem: "images.unsplash.com/photo-1654973552952-d0c98a3e3388?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      estoque: 30,
      avaliacao: 4.9,
      necessitaReceita: false,
      destaque: true,
    ...
    },
    {
      ...
      preco: 59.9,
      marca: "Addera D3",
      imagem: "https://images.unsplash.com/photo-1687200267991-d86b8df69968?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fHZpdGFtaW5zfGVufDB8fDB8fHww  ",
      estoque: 45,
      avaliacao: 4.8,
      necessitaReceita: false,
      destaque: false,
    ...
    },
    {
      ...
      preco: 42.5,
      marca: "Neutrogena",
      imagem: "https://images.unsplash.com/photo-1701992678962-41703126549c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fFNoYW1wb298ZW58MHx8MHx8fDA%3D",
      estoque: 25,
      avaliacao: 4.6,
      necessitaReceita: false,
      destaque: true,
    ...
    },
    {
      ...
      preco: 79.9,
      marca: "Pampers",
      imagem: "https://images.unsplash.com/photo-1584839404042-8bc21d240e91?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      estoque: 60,
      avaliacao: 4.5,
      necessitaReceita: false,
      destaque: false,
